...
- `root_attestation.dcbor` (authoritative bootstrap, REQUIRED)
...
- If both are present, consumers SHOULD treat `root_attestation.dcbor` as authoritative.

#### 2) Authority rule (integrity boundary)
- The **root attestation** is authoritative for the pack contents.
...
A verifier MUST:
1. Decode `root_attestation.dcbor` using canonical rules.
...
- Root attestation schema: `stunir_pack_root_attestation_v0.md`
