//! STUNIR Beam Emitter - Rust Implementation
//!
//! Generates BEAM VM languages.
...
impl BeamConfig {
    ...
    pub fn new(base: EmitterConfig, variant: BeamVariant) -> Self {
        Self { base, variant }
    }
}
...
impl BaseEmitter for BeamEmitter {
...
mod tests {
    ...
    fn test_beam_emitter() {
        ...
        let config = BeamConfig::new(base_config, BeamVariant::Erlang_BEAM);
        let emitter = BeamEmitter::new(config);
