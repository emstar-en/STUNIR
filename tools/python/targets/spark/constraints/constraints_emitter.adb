...
package body Constraints_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Constraints Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Constraints implementation goes here" & New_Line, Status);
   end Emit_Module;
