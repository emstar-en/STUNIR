--  STUNIR AsmIr Emitter - Ada SPARK Implementation
...
package body AsmIr_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated AsmIr Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Asm_Ir implementation goes here" & New_Line, Status);
   end Emit_Module;
