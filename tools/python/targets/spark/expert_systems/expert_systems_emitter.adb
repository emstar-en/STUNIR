--  STUNIR ExpertSystems Emitter - Ada SPARK Implementation
...
package body ExpertSystems_Emitter is
   ...
   end Map_Type_To_EXPERT_SYSTEMS;
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated ExpertSystems Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Expert_Systems implementation goes here" & New_Line, Status);
   end Emit_Module;
