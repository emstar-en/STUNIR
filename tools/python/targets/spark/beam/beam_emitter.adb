...
package body Beam_Emitter is
   ...
   function Map_Type_To_BEAM (IR_Type : IR_Data_Type) return Type_Name_String
   is
   begin
      case IR_Type is
         when Type_I32 =>
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Beam Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Beam implementation goes here" & New_Line, Status);
   end Emit_Module;
