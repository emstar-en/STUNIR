--  STUNIR Json Emitter - Ada SPARK Implementation
...
package body Json_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Json Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Json implementation goes here" & New_Line, Status);
   end Emit_Module;
