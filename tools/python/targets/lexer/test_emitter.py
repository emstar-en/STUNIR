...
class TestLexerEmitter(unittest.TestCase):
    """Test suite for Lexer emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Lexer type mapping."""
        emitter = LexerEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'lexer')
