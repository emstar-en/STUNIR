...
class TestBusinessEmitter(unittest.TestCase):
    """Test suite for Business emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Business type mapping."""
        emitter = BusinessEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'business')
