...
from emitter import ParserEmitter


class TestParserEmitter(unittest.TestCase):
    """Test suite for Parser emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Parser type mapping."""
        emitter = ParserEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'parser')
