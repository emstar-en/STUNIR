...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_stunir_ir_to_code_main" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#90180eaf#;
   pragma Export (C, u00001, "stunir_ir_to_code_mainB");
   ...
   u00118 : constant Version_32 := 16#d5607652#;
   pragma Export (C, u00118, "stunir_ir_to_codeB");
   u00119 : constant Version_32 := 16#9cefbe94#;
   pragma Export (C, u00119, "stunir_ir_to_codeS");
   ...
   u00185 : constant Version_32 := 16#27ac21ac#;
   pragma Export (C, u00185, "ada__text_ioB");
   u00186 : constant Version_32 := 16#b8eab78e#;
   pragma Export (C, u00186, "ada__text_ioS");
   u00187 : constant Version_32 := 16#cfe966a0#;
   pragma Export (C, u00187, "stunir_json_utilsB");
   u00188 : constant Version_32 := 16#60c94946#;
   pragma Export (C, u00188, "stunir_json_utilsS");
   ...
   u00205 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00205, "system__concat_4B");
   u00206 : constant Version_32 := 16#9b9180a0#;
   ...
   u00209 : constant Version_32 := 16#02cecc7b#;
   pragma Export (C, u00209, "system__concat_6B");
   u00210 : constant Version_32 := 16#2a3b2e96#;
   pragma Export (C, u00210, "system__concat_6S");
   u00211 : constant Version_32 := 16#ada38524#;
   pragma Export (C, u00211, "system__concat_7B");
   u00212 : constant Version_32 := 16#a1949e01#;
   pragma Export (C, u00212, "system__concat_7S");
   u00213 : constant Version_32 := 16#63bad2e6#;
   pragma Export (C, u00213, "system__concat_9B");
   u00214 : constant Version_32 := 16#fc8617f5#;
   pragma Export (C, u00214, "system__concat_9S");
   u00215 : constant Version_32 := 16#27f33f31#;
   pragma Export (C, u00215, "ada__strings__boundedB");
   u00216 : constant Version_32 := 16#7c1fc0ad#;
   pragma Export (C, u00216, "ada__strings__boundedS");
   u00217 : constant Version_32 := 16#b037be72#;
   pragma Export (C, u00217, "ada__strings__superboundedB");
   u00218 : constant Version_32 := 16#e0340eac#;
   pragma Export (C, u00218, "ada__strings__superboundedS");
   u00219 : constant Version_32 := 16#5b06ae56#;
   pragma Export (C, u00219, "stunirS");
   u00220 : constant Version_32 := 16#9fa454d0#;
   pragma Export (C, u00220, "stunir__semantic_irB");
   u00221 : constant Version_32 := 16#15612630#;
   pragma Export (C, u00221, "stunir__semantic_irS");
   u00222 : constant Version_32 := 16#ec63128c#;
   pragma Export (C, u00222, "stunir_string_builderB");
   u00223 : constant Version_32 := 16#4968345d#;
   pragma Export (C, u00223, "stunir_string_builderS");
   u00224 : constant Version_32 := 16#3124cfea#;
   pragma Export (C, u00224, "system__concat_8B");
   u00225 : constant Version_32 := 16#25e68f5f#;
   pragma Export (C, u00225, "system__concat_8S");
   ...
   --  stunir_json_utils%s
   --  stunir_json_utils%b
   --  stunir_string_builder%s
   --  stunir_string_builder%b
   --  stunir_ir_to_code%s
   --  stunir_ir_to_code%b
   --  stunir_ir_to_code_main%b
