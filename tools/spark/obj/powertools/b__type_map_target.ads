...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_type_map_target" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#19d1d1a0#;
   pragma Export (C, u00001, "type_map_targetB");
   ...
   u00062 : constant Version_32 := 16#c04dcb27#;
   pragma Export (C, u00062, "system__os_libB");
   u00063 : constant Version_32 := 16#2d02400e#;
   pragma Export (C, u00063, "system__os_libS");
   u00064 : constant Version_32 := 16#94d23d25#;
   pragma Export (C, u00064, "system__atomic_operations__test_and_setB");
   u00065 : constant Version_32 := 16#57acee8e#;
   pragma Export (C, u00065, "system__atomic_operations__test_and_setS");
   u00066 : constant Version_32 := 16#6f0aa5bb#;
   pragma Export (C, u00066, "system__atomic_operationsS");
   u00067 : constant Version_32 := 16#553a519e#;
   pragma Export (C, u00067, "system__atomic_primitivesB");
   u00068 : constant Version_32 := 16#a0b9547d#;
   pragma Export (C, u00068, "system__atomic_primitivesS");
   u00069 : constant Version_32 := 16#b98923bf#;
   pragma Export (C, u00069, "system__case_utilB");
   u00070 : constant Version_32 := 16#677a08cb#;
   pragma Export (C, u00070, "system__case_utilS");
   u00071 : constant Version_32 := 16#256dbbe5#;
   pragma Export (C, u00071, "system__stringsB");
   u00072 : constant Version_32 := 16#33ebdf86#;
   pragma Export (C, u00072, "system__stringsS");
   u00073 : constant Version_32 := 16#836ccd31#;
   pragma Export (C, u00073, "system__object_readerB");
   u00074 : constant Version_32 := 16#a4fd4a87#;
   pragma Export (C, u00074, "system__object_readerS");
   u00075 : constant Version_32 := 16#c901dc12#;
   pragma Export (C, u00075, "system__val_lliS");
   u00076 : constant Version_32 := 16#3fcf5e91#;
   pragma Export (C, u00076, "system__val_lluS");
   u00077 : constant Version_32 := 16#fb981c03#;
   ...
   u00096 : constant Version_32 := 16#6f36ca88#;
   ...
   u00100 : constant Version_32 := 16#659a73a2#;
   ...
   u00102 : constant Version_32 := 16#423bbbbc#;
   ...
   u00123 : constant Version_32 := 16#b52c8f67#;
   pragma Export (C, u00123, "system__finalization_primitivesS");
   u00124 : constant Version_32 := 16#3eb79f63#;
   pragma Export (C, u00124, "system__os_locksS");
   u00125 : constant Version_32 := 16#05222263#;
   pragma Export (C, u00125, "system__put_imagesB");
   u00126 : constant Version_32 := 16#b4c7d881#;
   ...
   u00129 : constant Version_32 := 16#6bdc0dbd#;
   ...
   u00135 : constant Version_32 := 16#084c2f63#;
   pragma Export (C, u00135, "ada__strings__searchB");
   u00136 : constant Version_32 := 16#97fe4a15#;
   pragma Export (C, u00136, "ada__strings__searchS");
   u00137 : constant Version_32 := 16#52627794#;
   pragma Export (C, u00137, "system__atomic_countersB");
   u00138 : constant Version_32 := 16#7471305d#;
   pragma Export (C, u00138, "system__atomic_countersS");
   u00139 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00139, "system__stream_attributesB");
   u00140 : constant Version_32 := 16#1462dbd4#;
   pragma Export (C, u00140, "system__stream_attributesS");
   u00141 : constant Version_32 := 16#1c617d0b#;
   pragma Export (C, u00141, "system__stream_attributes__xdrB");
   u00142 : constant Version_32 := 16#e4218e58#;
   pragma Export (C, u00142, "system__stream_attributes__xdrS");
   u00143 : constant Version_32 := 16#6b5b00f2#;
   pragma Export (C, u00143, "system__fat_fltS");
   u00144 : constant Version_32 := 16#4d6909ff#;
   pragma Export (C, u00144, "system__fat_lfltS");
   u00145 : constant Version_32 := 16#37b9a715#;
   pragma Export (C, u00145, "system__fat_llfS");
   u00146 : constant Version_32 := 16#27ac21ac#;
   pragma Export (C, u00146, "ada__text_ioB");
   u00147 : constant Version_32 := 16#b8eab78e#;
   pragma Export (C, u00147, "ada__text_ioS");
   u00148 : constant Version_32 := 16#1cacf006#;
   pragma Export (C, u00148, "interfaces__c_streamsB");
   u00149 : constant Version_32 := 16#d07279c2#;
   pragma Export (C, u00149, "interfaces__c_streamsS");
   u00150 : constant Version_32 := 16#ec2f4d1e#;
   pragma Export (C, u00150, "system__file_ioB");
   u00151 : constant Version_32 := 16#ce268ad8#;
   pragma Export (C, u00151, "system__file_ioS");
   u00152 : constant Version_32 := 16#221c42f4#;
   pragma Export (C, u00152, "system__file_control_blockS");
   u00153 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00153, "gnatS");
   u00154 : constant Version_32 := 16#ee3fdda3#;
   pragma Export (C, u00154, "gnat__command_lineB");
   u00155 : constant Version_32 := 16#492cbc46#;
   pragma Export (C, u00155, "gnat__command_lineS");
   u00156 : constant Version_32 := 16#351c5404#;
   pragma Export (C, u00156, "gnat__directory_operationsB");
   u00157 : constant Version_32 := 16#966cfc37#;
   pragma Export (C, u00157, "gnat__directory_operationsS");
   u00158 : constant Version_32 := 16#96a20755#;
   pragma Export (C, u00158, "ada__strings__fixedB");
   u00159 : constant Version_32 := 16#11b694ce#;
   pragma Export (C, u00159, "ada__strings__fixedS");
   u00160 : constant Version_32 := 16#656efae9#;
   pragma Export (C, u00160, "gnat__os_libS");
   u00161 : constant Version_32 := 16#ae5b86de#;
   pragma Export (C, u00161, "system__pool_globalB");
   u00162 : constant Version_32 := 16#1c3dab8f#;
   pragma Export (C, u00162, "system__pool_globalS");
   u00163 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00163, "system__memoryB");
   u00164 : constant Version_32 := 16#b0fd4384#;
