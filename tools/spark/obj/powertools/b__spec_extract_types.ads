...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_spec_extract_types" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#59d25ce4#;
   pragma Export (C, u00001, "spec_extract_typesB");
