...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ir_check_functions" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a42aa7de#;
   pragma Export (C, u00001, "ir_check_functionsB");
