...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_validation_reporter" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f1f91c08#;
   pragma Export (C, u00001, "validation_reporterB");
