...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_spec_extract_funcs" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1ac36b68#;
   pragma Export (C, u00001, "spec_extract_funcsB");
   ...
   u00153 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00153, "system__concat_3B");
   u00154 : constant Version_32 := 16#2213c63c#;
