...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_file_find" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4dde32d3#;
   pragma Export (C, u00001, "file_findB");
   ...
   u00185 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00185, "system__memoryB");
   u00186 : constant Version_32 := 16#b0fd4384#;
