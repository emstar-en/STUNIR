...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_json_merge" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8e2d4bd1#;
   pragma Export (C, u00001, "json_mergeB");
   ...
   u00164 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00164, "system__memoryB");
   u00165 : constant Version_32 := 16#b0fd4384#;
