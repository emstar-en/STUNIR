...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_code_gen_func_body" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f4252e62#;
   pragma Export (C, u00001, "code_gen_func_bodyB");
