...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_func_dedup" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7acd9961#;
   pragma Export (C, u00001, "func_dedupB");
   ...
   u00104 : constant Version_32 := 16#99bc7f89#;
   pragma Export (C, u00104, "ada__containers__hash_tablesS");
   u00105 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00105, "ada__containers__helpersB");
   u00106 : constant Version_32 := 16#444c93c2#;
   pragma Export (C, u00106, "ada__containers__helpersS");
   u00107 : constant Version_32 := 16#c34b231e#;
   pragma Export (C, u00107, "ada__finalizationS");
   u00108 : constant Version_32 := 16#b228eb1e#;
   pragma Export (C, u00108, "ada__streamsB");
   u00109 : constant Version_32 := 16#613fe11c#;
   ...
   u00113 : constant Version_32 := 16#c9e86997#;
   ...
   u00127 : constant Version_32 := 16#b4c7d881#;
   ...
   u00130 : constant Version_32 := 16#d00f339c#;
   pragma Export (C, u00130, "system__finalization_rootB");
   u00131 : constant Version_32 := 16#a215e14a#;
   ...
   u00133 : constant Version_32 := 16#7471305d#;
   pragma Export (C, u00133, "system__atomic_countersS");
   u00134 : constant Version_32 := 16#eab0e571#;
   pragma Export (C, u00134, "ada__containers__prime_numbersB");
   u00135 : constant Version_32 := 16#45c4b2d1#;
   pragma Export (C, u00135, "ada__containers__prime_numbersS");
   u00136 : constant Version_32 := 16#27f33f31#;
   pragma Export (C, u00136, "ada__strings__boundedB");
   u00137 : constant Version_32 := 16#7c1fc0ad#;
   pragma Export (C, u00137, "ada__strings__boundedS");
   u00138 : constant Version_32 := 16#084c2f63#;
   pragma Export (C, u00138, "ada__strings__searchB");
   u00139 : constant Version_32 := 16#97fe4a15#;
   pragma Export (C, u00139, "ada__strings__searchS");
   u00140 : constant Version_32 := 16#b037be72#;
   pragma Export (C, u00140, "ada__strings__superboundedB");
   u00141 : constant Version_32 := 16#e0340eac#;
   pragma Export (C, u00141, "ada__strings__superboundedS");
   u00142 : constant Version_32 := 16#52aa515b#;
   pragma Export (C, u00142, "ada__strings__hashB");
   u00143 : constant Version_32 := 16#1121e1f9#;
   pragma Export (C, u00143, "ada__strings__hashS");
   u00144 : constant Version_32 := 16#27ac21ac#;
   pragma Export (C, u00144, "ada__text_ioB");
   u00145 : constant Version_32 := 16#b8eab78e#;
   ...
   u00149 : constant Version_32 := 16#ce268ad8#;
   pragma Export (C, u00149, "system__file_ioS");
   u00150 : constant Version_32 := 16#ef3c5c6f#;
   pragma Export (C, u00150, "system__finalization_primitivesB");
   u00151 : constant Version_32 := 16#b52c8f67#;
   pragma Export (C, u00151, "system__finalization_primitivesS");
   u00152 : constant Version_32 := 16#3eb79f63#;
   pragma Export (C, u00152, "system__os_locksS");
   u00153 : constant Version_32 := 16#221c42f4#;
   pragma Export (C, u00153, "system__file_control_blockS");
   u00154 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00154, "gnatS");
   u00155 : constant Version_32 := 16#ee3fdda3#;
   pragma Export (C, u00155, "gnat__command_lineB");
   u00156 : constant Version_32 := 16#492cbc46#;
   pragma Export (C, u00156, "gnat__command_lineS");
   ...
   u00159 : constant Version_32 := 16#6bdc0dbd#;
   pragma Export (C, u00159, "system__return_stackS");
   u00160 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00160, "system__stream_attributesB");
   u00161 : constant Version_32 := 16#1462dbd4#;
   pragma Export (C, u00161, "system__stream_attributesS");
   u00162 : constant Version_32 := 16#1c617d0b#;
   pragma Export (C, u00162, "system__stream_attributes__xdrB");
   u00163 : constant Version_32 := 16#e4218e58#;
   pragma Export (C, u00163, "system__stream_attributes__xdrS");
   u00164 : constant Version_32 := 16#6b5b00f2#;
   pragma Export (C, u00164, "system__fat_fltS");
   u00165 : constant Version_32 := 16#4d6909ff#;
   pragma Export (C, u00165, "system__fat_lfltS");
   u00166 : constant Version_32 := 16#37b9a715#;
   pragma Export (C, u00166, "system__fat_llfS");
   u00167 : constant Version_32 := 16#351c5404#;
   pragma Export (C, u00167, "gnat__directory_operationsB");
   u00168 : constant Version_32 := 16#966cfc37#;
   pragma Export (C, u00168, "gnat__directory_operationsS");
   u00169 : constant Version_32 := 16#96a20755#;
   pragma Export (C, u00169, "ada__strings__fixedB");
   u00170 : constant Version_32 := 16#11b694ce#;
   pragma Export (C, u00170, "ada__strings__fixedS");
   u00171 : constant Version_32 := 16#656efae9#;
   pragma Export (C, u00171, "gnat__os_libS");
   u00172 : constant Version_32 := 16#ae5b86de#;
   pragma Export (C, u00172, "system__pool_globalB");
   u00173 : constant Version_32 := 16#1c3dab8f#;
   pragma Export (C, u00173, "system__pool_globalS");
   u00174 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00174, "system__memoryB");
   u00175 : constant Version_32 := 16#b0fd4384#;
   ...
   u00177 : constant Version_32 := 16#3202a6c5#;
   pragma Export (C, u00177, "system__storage_poolsS");
   u00178 : constant Version_32 := 16#690693e0#;
   pragma Export (C, u00178, "system__storage_pools__subpoolsB");
   u00179 : constant Version_32 := 16#23a252fc#;
   ...
   u00181 : constant Version_32 := 16#54c94065#;
   ...
   u00184 : constant Version_32 := 16#40fe4806#;
   pragma Export (C, u00184, "gnat__regexpS");
   u00185 : constant Version_32 := 16#8f8e85c2#;
   pragma Export (C, u00185, "system__regexpB");
   u00186 : constant Version_32 := 16#8b5b7852#;
   pragma Export (C, u00186, "system__regexpS");
   u00187 : constant Version_32 := 16#2b19e51a#;
   pragma Export (C, u00187, "gnat__stringsS");
   u00188 : constant Version_32 := 16#82e56cca#;
   pragma Export (C, u00188, "stunir_json_parserB");
   u00189 : constant Version_32 := 16#92ea68d6#;
   pragma Export (C, u00189, "stunir_json_parserS");
   u00190 : constant Version_32 := 16#41661247#;
   pragma Export (C, u00190, "stunir_typesS");
   u00191 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00191, "system__concat_2B");
   u00192 : constant Version_32 := 16#1d92ac69#;
   pragma Export (C, u00192, "system__concat_2S");
   u00193 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00193, "system__concat_3B");
   u00194 : constant Version_32 := 16#2213c63c#;
   pragma Export (C, u00194, "system__concat_3S");
   u00195 : constant Version_32 := 16#ebb39bbb#;
   pragma Export (C, u00195, "system__concat_5B");
   u00196 : constant Version_32 := 16#e8f00e45#;
