...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_type_normalize" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#fc9add02#;
   pragma Export (C, u00001, "type_normalizeB");
   ...
   u00180 : constant Version_32 := 16#2213c63c#;
   pragma Export (C, u00180, "system__concat_3S");
   u00181 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00181, "system__concat_4B");
   u00182 : constant Version_32 := 16#9b9180a0#;
