...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_schema_check_required" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b3f80bff#;
   pragma Export (C, u00001, "schema_check_requiredB");
