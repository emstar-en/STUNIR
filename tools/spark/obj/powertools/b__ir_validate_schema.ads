...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ir_validate_schema" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#43c72d5b#;
   pragma Export (C, u00001, "ir_validate_schemaB");
