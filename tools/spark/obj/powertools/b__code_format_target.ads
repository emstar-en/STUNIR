...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_code_format_target" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#80751972#;
   pragma Export (C, u00001, "code_format_targetB");
