...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_manifest_generate" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#80314f02#;
   pragma Export (C, u00001, "manifest_generateB");
   ...
   u00104 : constant Version_32 := 16#15c56056#;
   ...
   u00108 : constant Version_32 := 16#f169b552#;
   pragma Export (C, u00108, "system__os_primitivesB");
   u00109 : constant Version_32 := 16#af94ba68#;
   pragma Export (C, u00109, "system__os_primitivesS");
   u00110 : constant Version_32 := 16#afdc38b2#;
   pragma Export (C, u00110, "system__arith_64B");
   u00111 : constant Version_32 := 16#ecde1f4c#;
   pragma Export (C, u00111, "system__arith_64S");
   u00112 : constant Version_32 := 16#ff7f7d40#;
   pragma Export (C, u00112, "system__task_lockB");
   u00113 : constant Version_32 := 16#c9e3e8f0#;
   pragma Export (C, u00113, "system__task_lockS");
   u00114 : constant Version_32 := 16#8f947e37#;
   pragma Export (C, u00114, "system__win32__extS");
   u00115 : constant Version_32 := 16#c1ef1512#;
   pragma Export (C, u00115, "ada__calendar__formattingB");
   u00116 : constant Version_32 := 16#5a9d5c4e#;
   pragma Export (C, u00116, "ada__calendar__formattingS");
   u00117 : constant Version_32 := 16#974d849e#;
   pragma Export (C, u00117, "ada__calendar__time_zonesB");
   u00118 : constant Version_32 := 16#55da5b9f#;
   pragma Export (C, u00118, "ada__calendar__time_zonesS");
   u00119 : constant Version_32 := 16#b60bbeb4#;
   pragma Export (C, u00119, "system__val_fixed_64S");
   u00120 : constant Version_32 := 16#1640d433#;
   pragma Export (C, u00120, "system__val_intS");
   u00121 : constant Version_32 := 16#e1e75f5b#;
   pragma Export (C, u00121, "system__val_unsS");
   u00122 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00122, "ada__containers__helpersB");
   u00123 : constant Version_32 := 16#444c93c2#;
   pragma Export (C, u00123, "ada__containers__helpersS");
   u00124 : constant Version_32 := 16#c34b231e#;
   pragma Export (C, u00124, "ada__finalizationS");
   u00125 : constant Version_32 := 16#b228eb1e#;
   pragma Export (C, u00125, "ada__streamsB");
   u00126 : constant Version_32 := 16#613fe11c#;
   pragma Export (C, u00126, "ada__streamsS");
   u00127 : constant Version_32 := 16#a201b8c5#;
   pragma Export (C, u00127, "ada__strings__text_buffersB");
   u00128 : constant Version_32 := 16#a7cfd09b#;
   pragma Export (C, u00128, "ada__strings__text_buffersS");
   u00129 : constant Version_32 := 16#8b7604c4#;
   pragma Export (C, u00129, "ada__strings__utf_encodingB");
   u00130 : constant Version_32 := 16#c9e86997#;
   pragma Export (C, u00130, "ada__strings__utf_encodingS");
   u00131 : constant Version_32 := 16#bb780f45#;
   pragma Export (C, u00131, "ada__strings__utf_encoding__stringsB");
   u00132 : constant Version_32 := 16#b85ff4b6#;
   pragma Export (C, u00132, "ada__strings__utf_encoding__stringsS");
   u00133 : constant Version_32 := 16#d1d1ed0b#;
   pragma Export (C, u00133, "ada__strings__utf_encoding__wide_stringsB");
   u00134 : constant Version_32 := 16#5678478f#;
   ...
   u00150 : constant Version_32 := 16#7471305d#;
   pragma Export (C, u00150, "system__atomic_countersS");
   u00151 : constant Version_32 := 16#a1ad2589#;
   pragma Export (C, u00151, "ada__directories__hierarchical_file_namesB");
   u00152 : constant Version_32 := 16#34d5eeb2#;
   pragma Export (C, u00152, "ada__directories__hierarchical_file_namesS");
   u00153 : constant Version_32 := 16#c97ffcf7#;
   pragma Export (C, u00153, "ada__directories__validityB");
   u00154 : constant Version_32 := 16#0877bcae#;
   pragma Export (C, u00154, "ada__directories__validityS");
   u00155 : constant Version_32 := 16#96a20755#;
   pragma Export (C, u00155, "ada__strings__fixedB");
   u00156 : constant Version_32 := 16#11b694ce#;
   pragma Export (C, u00156, "ada__strings__fixedS");
   u00157 : constant Version_32 := 16#084c2f63#;
   pragma Export (C, u00157, "ada__strings__searchB");
   u00158 : constant Version_32 := 16#97fe4a15#;
   pragma Export (C, u00158, "ada__strings__searchS");
   u00159 : constant Version_32 := 16#4259a79c#;
   pragma Export (C, u00159, "ada__strings__unboundedB");
   u00160 : constant Version_32 := 16#b40332b4#;
   pragma Export (C, u00160, "ada__strings__unboundedS");
   u00161 : constant Version_32 := 16#ef3c5c6f#;
   pragma Export (C, u00161, "system__finalization_primitivesB");
   u00162 : constant Version_32 := 16#b52c8f67#;
   pragma Export (C, u00162, "system__finalization_primitivesS");
   u00163 : constant Version_32 := 16#3eb79f63#;
   pragma Export (C, u00163, "system__os_locksS");
   u00164 : constant Version_32 := 16#6bdc0dbd#;
   pragma Export (C, u00164, "system__return_stackS");
   u00165 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00165, "system__stream_attributesB");
   u00166 : constant Version_32 := 16#1462dbd4#;
   pragma Export (C, u00166, "system__stream_attributesS");
   u00167 : constant Version_32 := 16#1c617d0b#;
   pragma Export (C, u00167, "system__stream_attributes__xdrB");
   u00168 : constant Version_32 := 16#e4218e58#;
   pragma Export (C, u00168, "system__stream_attributes__xdrS");
   u00169 : constant Version_32 := 16#6b5b00f2#;
   pragma Export (C, u00169, "system__fat_fltS");
   u00170 : constant Version_32 := 16#4d6909ff#;
   pragma Export (C, u00170, "system__fat_lfltS");
   u00171 : constant Version_32 := 16#37b9a715#;
   pragma Export (C, u00171, "system__fat_llfS");
   u00172 : constant Version_32 := 16#3a8acc9b#;
   pragma Export (C, u00172, "system__file_attributesS");
   u00173 : constant Version_32 := 16#9cef2d5e#;
   pragma Export (C, u00173, "system__os_constantsS");
   u00174 : constant Version_32 := 16#ec2f4d1e#;
   pragma Export (C, u00174, "system__file_ioB");
   u00175 : constant Version_32 := 16#ce268ad8#;
   pragma Export (C, u00175, "system__file_ioS");
   u00176 : constant Version_32 := 16#1cacf006#;
   pragma Export (C, u00176, "interfaces__c_streamsB");
   u00177 : constant Version_32 := 16#d07279c2#;
   pragma Export (C, u00177, "interfaces__c_streamsS");
   u00178 : constant Version_32 := 16#221c42f4#;
   pragma Export (C, u00178, "system__file_control_blockS");
   u00179 : constant Version_32 := 16#8f8e85c2#;
   pragma Export (C, u00179, "system__regexpB");
   u00180 : constant Version_32 := 16#8b5b7852#;
   pragma Export (C, u00180, "system__regexpS");
   u00181 : constant Version_32 := 16#35d6ef80#;
   pragma Export (C, u00181, "system__storage_poolsB");
   u00182 : constant Version_32 := 16#3202a6c5#;
   pragma Export (C, u00182, "system__storage_poolsS");
   u00183 : constant Version_32 := 16#9e1315bc#;
   pragma Export (C, u00183, "ada__streams__stream_ioB");
   u00184 : constant Version_32 := 16#5dc4c9e4#;
   pragma Export (C, u00184, "ada__streams__stream_ioS");
   u00185 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00185, "system__communicationB");
   u00186 : constant Version_32 := 16#07dd39ad#;
   pragma Export (C, u00186, "system__communicationS");
   u00187 : constant Version_32 := 16#27ac21ac#;
   pragma Export (C, u00187, "ada__text_ioB");
   u00188 : constant Version_32 := 16#b8eab78e#;
   pragma Export (C, u00188, "ada__text_ioS");
   u00189 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00189, "gnatS");
   u00190 : constant Version_32 := 16#c083f050#;
   pragma Export (C, u00190, "gnat__sha256B");
   u00191 : constant Version_32 := 16#334ed1d9#;
   pragma Export (C, u00191, "gnat__sha256S");
   u00192 : constant Version_32 := 16#017d8c11#;
   pragma Export (C, u00192, "gnat__secure_hashesB");
   u00193 : constant Version_32 := 16#ab86b570#;
   pragma Export (C, u00193, "gnat__secure_hashesS");
   u00194 : constant Version_32 := 16#1538efc3#;
   pragma Export (C, u00194, "gnat__secure_hashes__sha2_32B");
   u00195 : constant Version_32 := 16#ebdefe7d#;
   pragma Export (C, u00195, "gnat__secure_hashes__sha2_32S");
   u00196 : constant Version_32 := 16#0668360c#;
   pragma Export (C, u00196, "gnat__byte_swappingB");
   u00197 : constant Version_32 := 16#b9234580#;
   pragma Export (C, u00197, "gnat__byte_swappingS");
   u00198 : constant Version_32 := 16#242c50b7#;
   pragma Export (C, u00198, "system__byte_swappingS");
   u00199 : constant Version_32 := 16#25a43d5d#;
   pragma Export (C, u00199, "gnat__secure_hashes__sha2_commonB");
   u00200 : constant Version_32 := 16#21653399#;
   pragma Export (C, u00200, "gnat__secure_hashes__sha2_commonS");
   u00201 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00201, "system__concat_2B");
   u00202 : constant Version_32 := 16#1d92ac69#;
   pragma Export (C, u00202, "system__concat_2S");
   u00203 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00203, "system__concat_3B");
   u00204 : constant Version_32 := 16#2213c63c#;
   pragma Export (C, u00204, "system__concat_3S");
   u00205 : constant Version_32 := 16#e2af0aa4#;
