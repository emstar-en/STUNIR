--  func_parse_sig - Parse function signatures from spec
...
procedure Func_Parse_Sig is
   ...
   Describe_Output : constant String :=
     "{" & ASCII.LF &
     "  ""tool"": ""func_parse_sig""," & ASCII.LF &
     "  ""version"": ""0.1.0-alpha""," & ASCII.LF &
     "  ""description"": ""Parse function signatures from spec""," & ASCII.LF &
     "  ""inputs"": [{" & ASCII.LF &
   ...
   begin
      Put_Line ("func_parse_sig - Parse function signatures");
      Put_Line ("Version: " & Version);
      Put_Line ("");
      Put_Line ("Usage: func_parse_sig [OPTIONS] < signature.txt");
      Put_Line ("");
      Put_Line ("Options:");
   ...
   function Parse_Signature (Sig : String) return String is
   begin
...
begin
   ...
   begin
      ...
      Put_Line (Parse_Signature (Content));
      Set_Exit_Status (Exit_Success);
   end;
