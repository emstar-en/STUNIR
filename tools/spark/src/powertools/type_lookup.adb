--  type_lookup - Look up type definitions
--  Type lookup utility for STUNIR powertools
...
procedure Type_Lookup is
   ...
   Describe_Output : constant String :=
     "{" & ASCII.LF &
     "  ""tool"": ""type_lookup""," & ASCII.LF &
     "  ""version"": ""0.1.0-alpha""," & ASCII.LF &
     "  ""description"": ""Look up type definitions""," & ASCII.LF &
     "  ""inputs"": [{" & ASCII.LF &
   ...
   begin
      Put_Line ("type_lookup - Look up type definitions");
      Put_Line ("Version: " & Version);
      Put_Line ("");
      Put_Line ("Usage: type_lookup [OPTIONS] [TYPE]");
      Put_Line ("       echo TYPE | type_lookup [OPTIONS]");
      Put_Line ("");
      Put_Line ("Options:");
      ...
      Put_Line ("  --type NAME       Type name to look up");
   end Print_Usage;
