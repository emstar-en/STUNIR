--  code_gen_func_body - Generate function bodies
...
procedure Code_Gen_Func_Body is
   ...
   Describe_Output : constant String :=
     "{" & ASCII.LF &
     "  ""tool"": ""code_gen_func_body""," & ASCII.LF &
     "  ""version"": ""0.1.0-alpha""," & ASCII.LF &
     "  ""description"": ""Generate function bodies""," & ASCII.LF &
     "  ""inputs"": [{" & ASCII.LF &
   ...
   begin
      Put_Line ("code_gen_func_body - Generate function bodies");
      Put_Line ("Version: " & Version);
      Put_Line ("");
      Put_Line ("Usage: code_gen_func_body [OPTIONS] --target LANG < spec.txt");
      Put_Line ("");
      Put_Line ("Options:");
...
begin
   ...
   declare
      ...
      Body_Str : constant String := Gen_Body (Spec, Target_Lang.all);
   begin
