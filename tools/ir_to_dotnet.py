...
def load_ir_manifest(path: Path) -> dict:
    """Load and validate an IR manifest JSON document."""
...
def gen_csproj() -> str:
    """Generate a basic .NET project file content."""
...
def gen_program_cs() -> str:
    """Generate the C# program source for hosted runtime output."""
...
def main() -> None:
    """Emit .NET hosted runtime project files from an IR manifest."""
