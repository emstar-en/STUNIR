#!/usr/bin/env python3
"""STUNIR C Emitter - C language emitter

This tool is part of the targets → c pipeline stage.
It converts STUNIR IR to C format.
...
class CEmitter:
    """Emitter for C code generation."""
    
    # Type mappings from STUNIR IR to C
    TYPE_MAP = {
        'i32': 'i32',
        'i64': 'i64',
        'f32': 'f32',
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='STUNIR C Emitter'
    )
    parser.add_argument('ir_file', help='Input IR JSON file')
    parser.add_argument('--output', '-o', required=True, help='Output directory')
    parser.add_argument('--headers', action='store_true', help='Enable headers')
    parser.add_argument('--structs', action='store_true', help='Enable structs')
    ...
    # Run emitter
    emitter = CEmitter(ir_data, args.output, vars(args))
