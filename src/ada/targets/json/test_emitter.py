...
class TestJsonEmitter(unittest.TestCase):
    """Test suite for Json emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Json type mapping."""
        emitter = JsonEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'json')
