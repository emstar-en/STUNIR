...
from emitter import FunctionalEmitter


class TestFunctionalEmitter(unittest.TestCase):
    """Test suite for Functional emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Functional type mapping."""
        emitter = FunctionalEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'functional')
