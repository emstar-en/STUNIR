--  STUNIR C Emitter - Ada SPARK Implementation
--  C language emitter
...
package body C_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated C Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// C implementation goes here" & New_Line, Status);
   end Emit_Module;
