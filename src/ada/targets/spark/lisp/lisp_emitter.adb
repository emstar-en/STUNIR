--  STUNIR Lisp Emitter - Ada SPARK Implementation
...
package body Lisp_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Lisp Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Lisp implementation goes here" & New_Line, Status);
   end Emit_Module;
