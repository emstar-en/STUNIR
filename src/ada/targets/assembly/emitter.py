#!/usr/bin/env python3
"""STUNIR Assembly Emitter - Assembly code emitter

This tool is part of the targets → assembly pipeline stage.
It converts STUNIR IR to Assembly format.
...
class AssemblyEmitter:
    """Emitter for Assembly code generation."""

    # Type mappings from STUNIR IR to Assembly
    TYPE_MAP = {
        'i32': 'i32',
        'i64': 'i64',
        'f32': 'f32',
    ...
    def emit_module(self, module_name: str) -> str:
        ...
        """
        header = [
            "/* STUNIR Generated Assembly Code */",
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self._write_file(f"{module_name}.s", code)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='STUNIR Assembly Emitter'
    )
    parser.add_argument('ir_file', help='Input IR JSON file')
    parser.add_argument('--output', '-o', required=True, help='Output directory')
    parser.add_argument('--registers', action='store_true', help='Enable registers')
    parser.add_argument('--sections', action='store_true', help='Enable sections')
    parser.add_argument('--calling_conventions', action='store_true', help='Enable calling_conventions')
    ...
    # Run emitter
    emitter = AssemblyEmitter(ir_data, args.output, vars(args))
