...
class TestAssemblyEmitter(unittest.TestCase):
    """Test suite for Assembly emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Assembly type mapping."""
        emitter = AssemblyEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'assembly')
