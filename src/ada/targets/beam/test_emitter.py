...
class TestBeamEmitter(unittest.TestCase):
    """Test suite for Beam emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Beam type mapping."""
        emitter = BeamEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'beam')
