...
1. **Type Definitions** (`types.rs`):
   ...
   pub struct IRStep {
       // ... existing fields ...
       pub expr: Option<String>,          // v0.9.0
       pub cases: Option<Vec<IRCase>>,    // v0.9.0
       pub default: Option<Vec<IRStep>>,  // v0.9.0
   }
   ```
...
**Status:** ⏸️ Deferred (requires bounded type system updates for v0.9.0 features)
...
| `combined_features.json` | All v0.9.0 features | ✅ Pass | ✅ Pass | ⏸️ N/A |
