...
package body Grammar_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Grammar Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Grammar implementation goes here" & New_Line, Status);
   end Emit_Module;
