...
package body Scientific_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Scientific Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Scientific implementation goes here" & New_Line, Status);
   end Emit_Module;
