--  STUNIR Prolog Emitter - Ada SPARK Implementation
...
package body Prolog_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Prolog Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Prolog implementation goes here" & New_Line, Status);
   end Emit_Module;
