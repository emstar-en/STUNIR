...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_phase4" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8e8d138e#;
   pragma Export (C, u00001, "test_phase4B");
   ...
   u00126 : constant Version_32 := 16#28860843#;
   pragma Export (C, u00126, "artifact_collectorB");
   u00127 : constant Version_32 := 16#e54eb59c#;
   pragma Export (C, u00127, "artifact_collectorS");
   u00128 : constant Version_32 := 16#0c17d799#;
   pragma Export (C, u00128, "package_typesB");
   u00129 : constant Version_32 := 16#de4b80b5#;
   pragma Export (C, u00129, "package_typesS");
   u00130 : constant Version_32 := 16#0143c3f3#;
   pragma Export (C, u00130, "do331_interfaceB");
   u00131 : constant Version_32 := 16#16058631#;
   pragma Export (C, u00131, "do331_interfaceS");
   u00132 : constant Version_32 := 16#61e84971#;
   pragma Export (C, u00132, "system__fat_fltS");
   u00133 : constant Version_32 := 16#cd8c2bca#;
   pragma Export (C, u00133, "do331_typesB");
   u00134 : constant Version_32 := 16#3d1c34e2#;
   pragma Export (C, u00134, "do331_typesS");
   u00135 : constant Version_32 := 16#414c971f#;
   pragma Export (C, u00135, "do332_interfaceB");
   u00136 : constant Version_32 := 16#a467c225#;
   pragma Export (C, u00136, "do332_interfaceS");
   u00137 : constant Version_32 := 16#2972f295#;
   pragma Export (C, u00137, "do332_typesB");
   u00138 : constant Version_32 := 16#fc472558#;
   pragma Export (C, u00138, "do332_typesS");
   u00139 : constant Version_32 := 16#15276107#;
   pragma Export (C, u00139, "do333_interfaceB");
   u00140 : constant Version_32 := 16#69a69070#;
   pragma Export (C, u00140, "do333_interfaceS");
   u00141 : constant Version_32 := 16#ff572035#;
   pragma Export (C, u00141, "do333_typesB");
   u00142 : constant Version_32 := 16#da5d3c82#;
   pragma Export (C, u00142, "do333_typesS");
   u00143 : constant Version_32 := 16#583bc2de#;
   pragma Export (C, u00143, "external_toolB");
   u00144 : constant Version_32 := 16#0a79f34a#;
   pragma Export (C, u00144, "external_toolS");
   u00145 : constant Version_32 := 16#1e1b5715#;
   pragma Export (C, u00145, "report_formatterB");
   u00146 : constant Version_32 := 16#c6dc2851#;
   pragma Export (C, u00146, "report_formatterS");
   u00147 : constant Version_32 := 16#190570e0#;
   pragma Export (C, u00147, "system__compare_array_unsigned_8B");
   u00148 : constant Version_32 := 16#323c087e#;
   ...
   u00150 : constant Version_32 := 16#dceebabd#;
   pragma Export (C, u00150, "system__address_operationsS");
   u00151 : constant Version_32 := 16#6aa09145#;
   pragma Export (C, u00151, "report_typesB");
   u00152 : constant Version_32 := 16#049199db#;
   pragma Export (C, u00152, "report_typesS");
   u00153 : constant Version_32 := 16#2a21063a#;
   pragma Export (C, u00153, "trace_matrixB");
   u00154 : constant Version_32 := 16#e2f2a895#;
   pragma Export (C, u00154, "trace_matrixS");
   u00155 : constant Version_32 := 16#1982dcd0#;
   pragma Export (C, u00155, "system__memoryB");
   u00156 : constant Version_32 := 16#f95ea4cd#;
   ...
   --  package_types%s
   --  package_types%b
   --  artifact_collector%s
   --  artifact_collector%b
   --  report_types%s
   --  report_types%b
   --  report_formatter%s
   --  report_formatter%b
