...
/// AsmIr configuration
#[derive(Debug, Clone)]
pub struct AsmIrConfig {
    pub indent_width: usize,
    pub validate: bool,
}

impl Default for AsmIrConfig {
    fn default() -> Self {
        Self {
            indent_width: 2,
            validate: true,
...
pub fn emit_module(
    ...
    // Header comments
    code.push_str("/* STUNIR Generated AsmIr Code */\n");
    code.push_str(&format!("/* Module: {} */\n", module_name));
    code.push_str("/* Generator: Rust Pipeline */\n");
    code.push_str("\n");
    
    // Module body
    code.push_str("// Asm_Ir implementation goes here\n");
...
pub fn emit(
    ...
    let config = AsmIrConfig::default();
