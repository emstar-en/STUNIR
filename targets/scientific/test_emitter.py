...
from emitter import ScientificEmitter


class TestScientificEmitter(unittest.TestCase):
    """Test suite for Scientific emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Scientific type mapping."""
        emitter = ScientificEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'scientific')
