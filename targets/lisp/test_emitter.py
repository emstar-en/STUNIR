...
from emitter import LispEmitter


class TestLispEmitter(unittest.TestCase):
    """Test suite for Lisp emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Lisp type mapping."""
        emitter = LispEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'lisp')
