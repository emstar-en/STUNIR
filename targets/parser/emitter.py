#!/usr/bin/env python3
"""STUNIR Parser Emitter - Parser generator for multiple languages

This tool is part of the targets → parser pipeline stage.
It converts STUNIR IR to Parser format.
...
class ParserEmitter:
    ...
    # Type mappings from STUNIR IR to Parser
    TYPE_MAP = {
        'i32': 'int32',
        'i64': 'int64',
        'f32': 'float',
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self._write_file(f"{module_name}.py", code)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='STUNIR Parser Emitter'
    )
    parser.add_argument('ir_file', help='Input IR JSON file')
    parser.add_argument('--output', '-o', required=True, help='Output directory')
    parser.add_argument('--recursive_descent', action='store_true', help='Enable recursive_descent')
    parser.add_argument('--lr_parsing', action='store_true', help='Enable lr_parsing')
    parser.add_argument('--ast_construction', action='store_true', help='Enable ast_construction')
    ...
    # Run emitter
    emitter = ParserEmitter(ir_data, args.output, vars(args))
