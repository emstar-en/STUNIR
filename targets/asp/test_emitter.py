...
class TestAspEmitter(unittest.TestCase):
    """Test suite for Asp emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Asp type mapping."""
        emitter = AspEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'asp')
