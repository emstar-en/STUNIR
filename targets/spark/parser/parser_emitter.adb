...
package body Parser_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Parser Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Parser implementation goes here" & New_Line, Status);
   end Emit_Module;
