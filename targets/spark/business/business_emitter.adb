--  STUNIR Business Emitter - Ada SPARK Implementation
...
package body Business_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Business Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Business implementation goes here" & New_Line, Status);
   end Emit_Module;
