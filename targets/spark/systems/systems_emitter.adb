--  STUNIR Systems Emitter - Ada SPARK Implementation
...
package body Systems_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Systems Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Systems implementation goes here" & New_Line, Status);
   end Emit_Module;
