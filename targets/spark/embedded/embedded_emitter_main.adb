...
procedure Embedded_Emitter_Main is
   ...
   Test_Module : Embedded_Module;
   Test_Func   : Embedded_Function;
...
begin
   ...
   Test_Module.Func_Count := 1;
   
   --  Initialize test function
   Test_Func.Name := Identifier_Strings.To_Bounded_String ("main");
   Test_Func.Return_Type := Type_I32;
   Test_Func.Param_Count := 0;
   Test_Func.Stmt_Count := 2;
   
   --  Add statements
   Test_Func.Statements (1) := (
   ...
   Test_Module.Functions (1) := Test_Func;
