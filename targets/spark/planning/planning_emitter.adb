...
package body Planning_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Planning Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Planning implementation goes here" & New_Line, Status);
   end Emit_Module;
