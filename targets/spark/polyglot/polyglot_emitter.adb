--  STUNIR Polyglot Emitter - Ada SPARK Implementation
...
package body Polyglot_Emitter is
   ...
   begin
      ...
      --  Header comments
      Append_To_Content (Content, "/* STUNIR Generated Polyglot Code */" & New_Line, Status);
      ...
      --  Module body
      Append_To_Content (Content, "// Polyglot implementation goes here" & New_Line, Status);
   end Emit_Module;
