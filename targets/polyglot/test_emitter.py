...
class TestPolyglotEmitter(unittest.TestCase):
    """Test suite for Polyglot emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Polyglot type mapping."""
        emitter = PolyglotEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'polyglot')
