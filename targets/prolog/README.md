...
# All Prolog tests
python -m pytest tests/codegen/test_*prolog*.py tests/codegen/test_yap*.py tests/codegen/test_xsb*.py tests/codegen/test_datalog*.py tests/ir/test_logic_ir.py -v
```
