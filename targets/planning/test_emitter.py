...
class TestPlanningEmitter(unittest.TestCase):
    """Test suite for Planning emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Planning type mapping."""
        emitter = PlanningEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'planning')
