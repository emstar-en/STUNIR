#!/usr/bin/env python3
"""STUNIR Planning Emitter - AI planning language emitter (PDDL, STRIPS, HTN)

This tool is part of the targets → planning pipeline stage.
It converts STUNIR IR to Planning format.
...
class PlanningEmitter:
    """Emitter for Planning code generation."""
    
    # Type mappings from STUNIR IR to Planning
    TYPE_MAP = {
        'i32': 'int32',
        'i64': 'int64',
        'f32': 'float',
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self._write_file(f"{module_name}.pddl", code)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='STUNIR Planning Emitter'
    )
    parser.add_argument('ir_file', help='Input IR JSON file')
    parser.add_argument('--output', '-o', required=True, help='Output directory')
    parser.add_argument('--action_definitions', action='store_true', help='Enable action_definitions')
    parser.add_argument('--preconditions', action='store_true', help='Enable preconditions')
    parser.add_argument('--effects', action='store_true', help='Enable effects')
    parser.add_argument('--domain_modeling', action='store_true', help='Enable domain_modeling')
    ...
    # Run emitter
    emitter = PlanningEmitter(ir_data, args.output, vars(args))
