#!/usr/bin/env python3
"""STUNIR Systems Emitter - Systems programming emitter (C, C++, Rust, Zig, Ada)

This tool is part of the targets → systems pipeline stage.
It converts STUNIR IR to Systems format.
...
class SystemsEmitter:
    """Emitter for Systems code generation."""
    
    # Type mappings from STUNIR IR to Systems
    TYPE_MAP = {
        'i32': 'int32',
        'i64': 'int64',
        'f32': 'float',
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self._write_file(f"{module_name}.c", code)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='STUNIR Systems Emitter'
    )
    parser.add_argument('ir_file', help='Input IR JSON file')
    parser.add_argument('--output', '-o', required=True, help='Output directory')
    parser.add_argument('--memory_safety', action='store_true', help='Enable memory_safety')
    parser.add_argument('--zero_cost_abstractions', action='store_true', help='Enable zero_cost_abstractions')
    parser.add_argument('--systems_apis', action='store_true', help='Enable systems_apis')
    parser.add_argument('--ffi', action='store_true', help='Enable ffi')
    ...
    # Run emitter
    emitter = SystemsEmitter(ir_data, args.output, vars(args))
