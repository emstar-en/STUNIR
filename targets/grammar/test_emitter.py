...
class TestGrammarEmitter(unittest.TestCase):
    """Test suite for Grammar emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to Grammar type mapping."""
        emitter = GrammarEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'grammar')
