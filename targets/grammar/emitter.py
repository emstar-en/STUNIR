#!/usr/bin/env python3
"""STUNIR Grammar Emitter - Grammar definition emitter (ANTLR, Yacc, PEG, EBNF)

This tool is part of the targets → grammar pipeline stage.
It converts STUNIR IR to Grammar format.
...
class GrammarEmitter:
    """Emitter for Grammar code generation."""
    
    # Type mappings from STUNIR IR to Grammar
    TYPE_MAP = {
        'i32': 'int32',
        'i64': 'int64',
        'f32': 'float',
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self._write_file(f"{module_name}.g4", code)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='STUNIR Grammar Emitter'
    )
    parser.add_argument('ir_file', help='Input IR JSON file')
    parser.add_argument('--output', '-o', required=True, help='Output directory')
    parser.add_argument('--lexer_rules', action='store_true', help='Enable lexer_rules')
    parser.add_argument('--parser_rules', action='store_true', help='Enable parser_rules')
    parser.add_argument('--ast_generation', action='store_true', help='Enable ast_generation')
    parser.add_argument('--error_recovery', action='store_true', help='Enable error_recovery')
    ...
    # Run emitter
    emitter = GrammarEmitter(ir_data, args.output, vars(args))
