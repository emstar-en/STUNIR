...
from emitter import AsmIrEmitter


class TestAsmIrEmitter(unittest.TestCase):
    """Test suite for AsmIr emitter."""
    ...
    def test_type_mapping(self):
        """Test IR type to AsmIr type mapping."""
        emitter = AsmIrEmitter(self.test_ir, self.temp_dir)
    ...
    def test_run(self):
        ...
        self.assertEqual(manifest['category'], 'asm_ir')
