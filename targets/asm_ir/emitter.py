#!/usr/bin/env python3
"""STUNIR AsmIr Emitter - Assembly IR emitter (LLVM IR, custom IR formats)

This tool is part of the targets → asm_ir pipeline stage.
It converts STUNIR IR to AsmIr format.
...
class AsmIrEmitter:
    """Emitter for AsmIr code generation."""
    
    # Type mappings from STUNIR IR to AsmIr
    TYPE_MAP = {
        'i32': 'int32',
        'i64': 'int64',
        'f32': 'float',
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self._write_file(f"{module_name}.ll", code)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='STUNIR AsmIr Emitter'
    )
    parser.add_argument('ir_file', help='Input IR JSON file')
    parser.add_argument('--output', '-o', required=True, help='Output directory')
    parser.add_argument('--ssa_form', action='store_true', help='Enable ssa_form')
    parser.add_argument('--type_system', action='store_true', help='Enable type_system')
    parser.add_argument('--basic_blocks', action='store_true', help='Enable basic_blocks')
    parser.add_argument('--phi_nodes', action='store_true', help='Enable phi_nodes')
    ...
    # Run emitter
    emitter = AsmIrEmitter(ir_data, args.output, vars(args))
