#!/usr/bin/env python3
"""STUNIR Lexer Emitter - Lexer/tokenizer generator for multiple languages

This tool is part of the targets → lexer pipeline stage.
It converts STUNIR IR to Lexer format.
...
class LexerEmitter:
    ...
    # Type mappings from STUNIR IR to Lexer
    TYPE_MAP = {
        'i32': 'int32',
        'i64': 'int64',
        'f32': 'float',
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='STUNIR Lexer Emitter'
    )
    parser.add_argument('ir_file', help='Input IR JSON file')
    parser.add_argument('--output', '-o', required=True, help='Output directory')
    parser.add_argument('--regex_patterns', action='store_true', help='Enable regex_patterns')
    parser.add_argument('--token_types', action='store_true', help='Enable token_types')
    parser.add_argument('--error_handling', action='store_true', help='Enable error_handling')
    parser.add_argument('--position_tracking', action='store_true', help='Enable position_tracking')
    ...
    # Run emitter
    emitter = LexerEmitter(ir_data, args.output, vars(args))
