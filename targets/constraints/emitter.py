#!/usr/bin/env python3
"""STUNIR Constraints Emitter - Constraint satisfaction and optimization emitter

This tool is part of the targets → constraints pipeline stage.
It converts STUNIR IR to Constraints format.
...
class ConstraintsEmitter:
    """Emitter for Constraints code generation."""
    
    # Type mappings from STUNIR IR to Constraints
    TYPE_MAP = {
        'i32': 'int32',
        'i64': 'int64',
        'f32': 'float',
    ...
    def __init__(self, ir_data: Dict[str, Any], out_dir: Path, options: Optional[Dict] = None):
        """Initialize Constraints emitter.
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self._write_file(f"{module_name}.mzn", code)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='STUNIR Constraints Emitter'
    )
    parser.add_argument('ir_file', help='Input IR JSON file')
    parser.add_argument('--output', '-o', required=True, help='Output directory')
    parser.add_argument('--global_constraints', action='store_true', help='Enable global_constraints')
    parser.add_argument('--optimization', action='store_true', help='Enable optimization')
    parser.add_argument('--search_strategies', action='store_true', help='Enable search_strategies')
    parser.add_argument('--model_validation', action='store_true', help='Enable model_validation')
    ...
    # Run emitter
    emitter = ConstraintsEmitter(ir_data, args.output, vars(args))
